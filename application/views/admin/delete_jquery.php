        ...
        <tbody>
          ...
          ?>
            <tr>
                ...
                <td>
                    <button class="btn btn-danger delete1" onclick="openUrl()" style="color: red;" user-id="<?php echo $value['uid'];?>"/><i class="fa fa-trash-o" aria-hidden="true"></i></button>
...
$('.delete1').click(function(){
  var usid=$(this).attr('user-id');
  console.log(usid);
   if(usid !=''){
        var result = confirm("Are you sure to delete user record?");
        if(result){
            window.location.href = '<?= base_url() ?>'+'Admin/confirm_delete/'+usid;
        }else{
